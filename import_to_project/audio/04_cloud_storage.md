...
Import data from connected cloud storage. Audio recordings are always copied to Supervisely: importing audio as links is not supported.
...
<div style="display: grid; grid-template-columns: auto 1fr; grid-column-gap: 5px; grid-row-gap: 10px; grid-auto-rows: auto;">
  ...
  <b style="font-weight: 600; flex: none;" class="mr5">Audio formats:</b>
  <span><code>.wav</code>, <code>.flac</code>, <code>.mp3</code>, <code>.ogg</code>, <code>.m4a</code></span>
